...
class ApplockKeyboard : InputMethodService(),KeyboardView.OnKeyboardActionListener {
    ...
    override fun onKey(p0: Int, p1: IntArray?) {
        ...
        when (p0) {
            ...
            Keyboard.KEYCODE_DONE -> ic.sendKeyEvent(KeyEvent(KeyEvent.ACTION_DOWN, KEYCODE_ENTER))
            else -> {
    ...
    override fun onDestroy() {
        Toast.makeText(applicationContext,"destroyed" + s , Toast.LENGTH_SHORT).show()
        super.onDestroy()
    }
